# LAVA: The Latent Ability Variation Autoencoder
...
│                         lava and configuration for tools like black
│
...
│
└── lava   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes lava a Python module
    │
